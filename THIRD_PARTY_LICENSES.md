...
Every dependency of Scena, its exact pinned version, license, and where it
...
| pugixml    | v1.14   | MIT          | XML reading: OpenDRIVE road backend (roads/opendrive) and the OpenSCENARIO XML frontend (frontends/xml) | <https://github.com/zeux/pugixml> |
