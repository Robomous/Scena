...
| TrajectoryPosition | §6.3.8 | In | p2-s5 | `position_test.cpp` (reported unsupported); resolution planned (p2-s5) | IR + resolver dispatch landed (p2-s4); resolution needs trajectory shapes → p2-s5 |
