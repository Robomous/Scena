...
Scena must be safely embeddable in commercial simulation products, and its
...
- The `scena-core` runtime library keeps zero third-party runtime
...
Studying other engines' code to derive Scena's implementation is not
